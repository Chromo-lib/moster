...
const tabs = [
  ...
  { id: 1, title: 'last 20 downloads', comp: <ListDownloads />, svg:<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="download" className="svg-inline--fa fa-download fa-w-16" role="img" viewBox="0 0 512 512">
